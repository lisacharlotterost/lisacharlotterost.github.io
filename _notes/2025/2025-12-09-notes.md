...
categories: [notes]
comments: disabled
image: /pic/notes/screenshot-sublime.png
layout: post
...
tags: [Blog setup, AI, Automatization]
---

![](/pic/notes/screenshot-sublime.png)

Today and yesterday I let Claude, Gemini and ChatGPT improve my Notes setup on my blog. (I don’t pay for any of them, so I cycle through them.) Last week, I had this epiphany that I have a lot of content I wrote out there that lives not on my website, but other platforms. Lots of [tweets](https://x.com/lisacmuth), yes — but also tiny blog posts I wrote years ago. 

I call them „notes“. 

I wanted to bring them all together: For archiving purposes, but also as a backlog for creating more of them. So I added all posts from my TheLisaProject Tumblr, LisaNY Tumblr, and [the Notion „blog“ in which I document all my Color book updates](https://datawrapper.notion.site/Color-Book-Updates-54905c2bd0bb4c6bae15d99e31a9d5c4). I was positively surprised about both the Tumblr and the Notion export, and **how quickly the LLMs came up with a working Python script that turned JSONs and HTML files into Jekyll-compatible Markdown files with a consistent frontmatter**. Neat! 

Today and yesterday I finetuned everything (e.g. by fixing Markdown formatting or [setting up an RSS feed for these notes](https://lisacharlottemuth.com/notes.xml)), and I set up a **[GitHub Action](https://github.com/features/actions)** that checks every six hours if there’s a new post on my Tumblr and then takes its content and puts it in my GitHub page. 
