...
2020 was full of corona charts. On March 6, I published the article ["17 (or so) responsible live visualizations about the coronavirus, for you to use"](https://blog.datawrapper.de/coronaviruscharts/) and spent a lot of time maintaining it. It still updates now, in September 2021, while I'm writing these words. 
...
From our feature announcement "Create better, more responsive text annotations (yes, also on maps)". [**Read it here.**](https://blog.datawrapper.de/better-more-responsive-annotations-in-datawrapper-data-visualizations/)<br><br>
<p>
...
From my blog post "How to visualize polls & results of the U.S. elections with Datawrapper". [**Read it here.**](https://blog.datawrapper.de/how-to-visualize-the-us-election-2020-with-datawrapper/)
<br><br>
<p>
...
From my Weekly Chart "Women graduate, men are in power". [**Read it here.**](https://blog.datawrapper.de/weekly-chart-women-study-more/)
<br><br>
<p>
...
From my Weekly Chart "How I brought column charts into map tooltips". [**Read it here.**](https://blog.datawrapper.de/weekly-chart-map-tooltips/)
<br><br>
<p>
...
From our feature announcement "New in locator maps: Add regions as area markers". [**Read it here.**](https://blog.datawrapper.de/locatormap-highlight-regions/)
<br><br>
<p>
...
From my Weekly Chart "Why the UK has the better system for public holidays". [**Read it here.**](https://blog.datawrapper.de/weekly-chart-public-holidays-december/)
<br><br>
<p>
...
From my Weekly Chart "#FlattenTheCurve, but by how much?". [**Read it here.**](https://blog.datawrapper.de/weekly-chart-coronavirus-doublingtimes/)
