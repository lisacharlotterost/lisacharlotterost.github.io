...
In November 2017, we published the first Weekly Chart on the Datawrapper Blog – and since then, every single week. In the beginning, it was only me who visualized some dataset and wrote a few words about it. In June 2019, that [changed](https://blog.datawrapper.de/weekly-chart-why-you-will-hear-more-from-other-datawrapper-employees/): All of my coworkers are writing Weekly Charts these days; every one of them at least once a year. 
...
From our feature announcement "New: Add place labels in choropleth and symbol maps with one click". [**Read it here.**](https://blog.datawrapper.de/place-labels-in-choropleth-symbol-maps/)
<br><br>
<p>
...
From my Weekly Chart "The older you get, the higher your life expectancy". [**Read it here.**](https://blog.datawrapper.de/the-older-you-get-the-higher-your-life-expectancy/)
<br><br>
<p>
...
From my Weekly Chart "Does a higher budget make a movie more successful?". [**Read it here.**](https://blog.datawrapper.de/higher-budget-more-successful-movies/)
<br><br>
<p>
...
From my Weekly Chart "The oldest U.S. Senate to date, but not the least representative". [**Read it here.**](https://blog.datawrapper.de/age-of-us-senators-charts/)
<br><br>
<p>
...
From my Weekly Chart "When will Europe phase out coal?". [**Read it here.**](https://blog.datawrapper.de/place-labels-in-choropleth-symbol-maps/)
<br><br>
<p>
...
From our feature announcement "Show confidence intervals and value markers in Datawrapper bar charts". [**Read it here.**](https://blog.datawrapper.de/confidence-intervals-value-markers-bar-charts/)
<br><br>
<p>
...
From my Weekly Chart "A full month more above 20°C". [**Read it here.**](https://blog.datawrapper.de/days-per-year-above-temperature-climate-berlin/)
